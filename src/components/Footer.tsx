  ...
  return (
    <footer className="footer">
      Made with <a 
        ...
        className="inline-block relative w-4 h-4 align-text-bottom group"
      >
        ...
        <span className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--primary-dark)" viewBox="0 0 16 16">
